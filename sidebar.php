        ...
        <?php endif; ?>
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <!-- ADD THIS INSIDE THE <ul class="nav nav-pills nav-sidebar flex-column ..."> -->
  ...
  <li class="nav-item">
    <a href="./index.php?page=resources" class="nav-link nav-resources">
      <i class="nav-icon fas fa-folder-open"></i>
      <p>Resources</p>
    </a>
  </li>
  <li class="nav-item">
  <a href="./index.php?page=assets_dashboard" class="nav-link nav-assets">
