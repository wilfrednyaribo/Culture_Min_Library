		...
		<div class="col-md-8">
			<div class="card card-outline card-success">
				<div class="card-header">
					<h3 class="card-title"><b>Ticket Details</b></h3>
				</div>
				<div class="card-body">
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-6">
								...
								<p class="ml-2 d-list"><?php echo $subject ?></p>
								<label for="" class="control-label border-bottom border-primary">Requesting  person:</label>
								<p class="ml-2 d-list"><?php echo $cname ?></p>
							</div>
							<div class="col-md-6">
								...
								<label for="" class="control-label border-bottom border-primary">Office Requesting for Assistance:</label>
								<p class="ml-2 d-list"><?php echo $dname ?></p>
							</div>
						</div>
						<h6><b>Brief Description of the problem:</b></h6>
